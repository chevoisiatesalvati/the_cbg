...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      ogDescription: "The Celo Button Game is a fun and simple game that will let the latest one who", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
