...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_BUTTON_GAME_ADDRESS_MAINNET: z.string().optional(),
    NEXT_PUBLIC_BUTTON_GAME_ADDRESS_TESTNET: z.string().optional(),
  },
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_BUTTON_GAME_ADDRESS_MAINNET: process.env.NEXT_PUBLIC_BUTTON_GAME_ADDRESS_MAINNET,
    NEXT_PUBLIC_BUTTON_GAME_ADDRESS_TESTNET: process.env.NEXT_PUBLIC_BUTTON_GAME_ADDRESS_TESTNET,
  },
});
